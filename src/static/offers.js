export const offers = [
  {
    ...
    details: [
      ...
      { id: 2, value: 'Unlimited Bandwidth', field: 'Bandwidth' },
      { id: 3, value: 'Free SSL Certificate', field: 'SSL Certificate' },
      { id: 4, value: '24/7 Support', field: 'Support' },
      { id: 5, value: '2GB NVMe', field: 'Storage' },
      { id: 6, value: 'Free', field: 'SSL Certificate' },
    ],
    extra: [
      { id: 0, title: 'DDOS Protection', key: 'DDOS_PROTECTION', price: 34.99, discount: 100, isEnabled: true },
      { id: 1, title: 'Daily Backups', key: 'DAILY_BACKUPS', price: 34.99, discount: 100, isEnabled: true },
      {
        id: 2,
        title: 'Extended Technical Support',
        key: 'EXTENDED_TECHNICAL_SUPPORT',
        price: 34.99,
        discount: 50,
        isEnabled: false,
      },
...
const assembleOffersGroup = (array) => {
  const group = [];

  array.forEach((id) => group.push(offers[id]));

  return group;
};

export const home = assembleOffersGroup([4, 2, 5, 6]);
export const hosting = assembleOffersGroup([4, 2, 5, 6]);
export const builder = assembleOffersGroup([4, 2, 5, 6]);
export const orderHosting = assembleOffersGroup([4, 2, 5, 6]);

export const offersCollection = {
  home,
  hosting,
  builder,
  'order-hosting': orderHosting,
};
