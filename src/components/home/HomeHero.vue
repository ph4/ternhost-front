<template>
  <section class="hero">
    <base-container>
      <div class="hero-text">
        <h1>Fully Managed Cloud <br />& Wordpress Hosting</h1>
        <h3>
...
.hero {
  ...
  .container {
    ...
    .hero-text {
      ...
      h1 {
        @include fluid-type($text-4xl, $text-5xl);
        @include text(700, $blue-200);
      }
      h3 {
        @include fluid-type($text-base, $text-base);
        @include text(400, rgba($blue-200, 0.5));
        margin: 2.25rem 0;
      }
    }
  }
